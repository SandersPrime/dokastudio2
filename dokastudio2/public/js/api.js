...
const SessionAPI = {
    ...
    async getTeams(pinCode) {
        const normalizedPin = String(pinCode || '').trim();
        const response = await fetch(
            `${API_URL}/sessions/pin/${encodeURIComponent(normalizedPin)}/teams`,
            { headers: getHeaders() }
        );
    ...
    async updateTeams(pinCode, teams) {
        const normalizedPin = String(pinCode || '').trim();
        const response = await fetch(
            `${API_URL}/sessions/pin/${encodeURIComponent(normalizedPin)}/teams`,
            {
...
const BuzzerAPI = {
    async getStatus() {
        const response = await fetch(`${API_URL}/buzzer/status`, {
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    },
    ...
    async getDevices() {
        const response = await fetch(`${API_URL}/buzzer/devices`, {
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    },
    ...
    async testStart() {
        const response = await fetch(`${API_URL}/buzzer/test/start`, {
            method: 'POST',
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    ...
    async testStop() {
        const response = await fetch(`${API_URL}/buzzer/test/stop`, {
            method: 'POST',
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    ...
    async reset() {
        const response = await fetch(`${API_URL}/buzzer/reset`, {
            method: 'POST',
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    ...
    async getAssignments() {
        const response = await fetch(`${API_URL}/buzzer/assignments`, {
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    },
    ...
    async setMode(mode) {
        const response = await fetch(`${API_URL}/buzzer/mode`, {
            method: 'POST',
            headers: getHeaders(),
    ...
    async resetLock() {
        const response = await fetch(`${API_URL}/buzzer/reset-lock`, {
            method: 'POST',
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    ...
    async getRuntime() {
        const response = await fetch(`${API_URL}/buzzer/runtime`, {
            headers: getHeaders(),
        });
        return parseJsonResponse(response);
    },
...
window.BuzzerService = window.BuzzerService || BuzzerAPI;

...
function loadAdvancedSettings(question) {
    ...
    const setPressed = (id, value) => {
        const el = document.getElementById(id);
        if (!el) return;
        el.classList.toggle('is-active', Boolean(value));
    ...
    setValue('answerCardColor', appearance.answerCardColor, '#ffffff');
    setValue('answerCardStyle', appearance.answerCardStyle, 'rounded');
    setValue('answerAccentWeight', appearance.answerAccentWeight, 1);
    setValue('answerGap', appearance.answerGap, 12);
    setValue('answerCardOpacity', appearance.answerCardOpacity, 92);
    setValue('questionFont', appearance.questionFont, "'Inter', sans-serif");
    setValue('answerFont', appearance.answerFont, "'Inter', sans-serif");
    setValue('questionAlign', appearance.questionAlign || appearance.textAlign, 'left');
    setValue('answerAlign', appearance.answerAlign || appearance.textAlign, 'left');
    setValue('textAlign', appearance.questionAlign || appearance.textAlign, 'left');
    ...
    setValue('backgroundType', appearance.backgroundType, question.backgroundImageUrl ? 'image' : 'color');
    setValue('backgroundGradientStart', appearance.backgroundGradientStart, '#f6f8fb');
    setValue('backgroundGradientEnd', appearance.backgroundGradientEnd, '#dfe7ff');
    setValue('backgroundGradientDirection', appearance.backgroundGradientDirection, '135deg');
    setValue('backgroundGradient', appearance.backgroundGradient, '');
    setValue('backgroundImageFit', appearance.backgroundImageFit, 'cover');
    setValue('backgroundVideoUrl', appearance.backgroundVideoUrl, '');
    setChecked('backgroundVideoMuted', appearance.backgroundVideoMuted, true);
    setChecked('backgroundVideoLoop', appearance.backgroundVideoLoop, true);
    setValue('backgroundOverlayColor', appearance.backgroundOverlayColor, '#000000');
    setValue('backgroundOverlayOpacity', appearance.backgroundOverlayOpacity, 0);
    setValue('contentAlign', appearance.contentAlign, 'stretch');
    setValue('contentVertical', appearance.contentVertical, 'center');
    ...
    if (typeof window.updateBackgroundToolbar === 'function') {
